namespace Dominio
{
    public class Sistema
    {
        ...
        public Sistema()
        {
            ...
            {
                new Vuelo("AR101", Rutas[0], Aviones[0], new Frecuencia[] { Frecuencia.lunes, Frecuencia.viernes }),
                new Vuelo("LA203", Rutas[1], Aviones[1], new Frecuencia[] { Frecuencia.martes, Frecuencia.sabado }),
                new Vuelo("UX309", Rutas[2], Aviones[2], new Frecuencia[] { Frecuencia.miercoles, Frecuencia.domingo }),
                new Vuelo("AF450", Rutas[3], Aviones[3], new Frecuencia[] { Frecuencia.jueves, Frecuencia.domingo }),
                new Vuelo("IB333", Rutas[4], Aviones[0], new Frecuencia[] { Frecuencia.lunes, Frecuencia.martes }),
                new Vuelo("DL220", Rutas[5], Aviones[1], new Frecuencia[] { Frecuencia.viernes, Frecuencia.sabado }),
                new Vuelo("UA875", Rutas[6], Aviones[2], new Frecuencia[] { Frecuencia.jueves, Frecuencia.viernes }),
                new Vuelo("LH708", Rutas[7], Aviones[3], new Frecuencia[] { Frecuencia.miercoles }),
                new Vuelo("KL110", Rutas[8], Aviones[0], new Frecuencia[] { Frecuencia.lunes, Frecuencia.martes, Frecuencia.jueves }),
                new Vuelo("AZ556", Rutas[9], Aviones[1], new Frecuencia[] { Frecuencia.sabado }),
                new Vuelo("AC990", Rutas[10], Aviones[2], new Frecuencia[] { Frecuencia.domingo }),
                new Vuelo("JJ777", Rutas[11], Aviones[3], new Frecuencia[] { Frecuencia.lunes, Frecuencia.miercoles }),
                new Vuelo("NH852", Rutas[12], Aviones[0], new Frecuencia[] { Frecuencia.martes, Frecuencia.viernes }),
                new Vuelo("QF908", Rutas[13], Aviones[1], new Frecuencia[] { Frecuencia.lunes }),
                new Vuelo("EK202", Rutas[14], Aviones[2], new Frecuencia[] { Frecuencia.miercoles, Frecuencia.sabado }),
                new Vuelo("QR118", Rutas[15], Aviones[3], new Frecuencia[] { Frecuencia.jueves }),
                new Vuelo("LA515", Rutas[16], Aviones[0], new Frecuencia[] { Frecuencia.viernes, Frecuencia.domingo }),
                new Vuelo("AV300", Rutas[17], Aviones[1], new Frecuencia[] { Frecuencia.lunes }),
                new Vuelo("AR132", Rutas[18], Aviones[2], new Frecuencia[] { Frecuencia.martes }),
                new Vuelo("IB440", Rutas[19], Aviones[3], new Frecuencia[] { Frecuencia.miercoles, Frecuencia.sabado }),
                new Vuelo("DL155", Rutas[20], Aviones[0], new Frecuencia[] { Frecuencia.lunes, Frecuencia.viernes }),
                new Vuelo("AF621", Rutas[21], Aviones[1], new Frecuencia[] { Frecuencia.jueves, Frecuencia.domingo }),
                new Vuelo("KL205", Rutas[22], Aviones[2], new Frecuencia[] { Frecuencia.sabado }),
                new Vuelo("BA775", Rutas[23], Aviones[3], new Frecuencia[] { Frecuencia.martes, Frecuencia.viernes }),
                new Vuelo("JJ803", Rutas[24], Aviones[0], new Frecuencia[] { Frecuencia.domingo }),
                new Vuelo("AZ313", Rutas[25], Aviones[1], new Frecuencia[] { Frecuencia.miercoles }),
                new Vuelo("AC499", Rutas[26], Aviones[2], new Frecuencia[] { Frecuencia.lunes, Frecuencia.jueves }),
                new Vuelo("NH404", Rutas[27], Aviones[3], new Frecuencia[] { Frecuencia.viernes }),
                new Vuelo("QF878", Rutas[28], Aviones[0], new Frecuencia[] { Frecuencia.martes, Frecuencia.sabado }),
                new Vuelo("EK301", Rutas[29], Aviones[1], new Frecuencia[] { Frecuencia.domingo, Frecuencia.jueves }),
            };
